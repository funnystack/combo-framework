...
<form id="codeform" action="<%=basePath%>getCode.do" method="post">
    <table>
        <tr>
            ...
            <td><input type="text" id="packagename" name="packagename" value="cn.com.autohome.mall.erp.soa" size="40">
            </td>
        </tr>
        <tr>
...
<div>
    <a href="/download/SqlMapper.java"
...
<div class="page-footer-inner">
    <a href="https://github.com/funny5258/autocode"
       title="如果觉得好,请在github给我个星" target="_blank">
        2016 &copy; Auther by funny5258
    </a>
</div>
