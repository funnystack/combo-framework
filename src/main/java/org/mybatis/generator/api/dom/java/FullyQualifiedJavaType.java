...
public class FullyQualifiedJavaType implements
    ...
    public static final FullyQualifiedJavaType getUNObjectInstance() {
        if (objectInstance == null) {
            objectInstance = new FullyQualifiedJavaType("com.un.general.domain.UNObject"); //$NON-NLS-1$
        }

        return objectInstance;
    }
    
    public static final FullyQualifiedJavaType getUNDaoInstance() {
        if (objectInstance == null) {
            objectInstance = new FullyQualifiedJavaType("com.un.general.dao.UNDao"); //$NON-NLS-1$
        }
