...
public class Context extends PropertyHolder {
    ...
    /**
     * @return the tabconfig
     */
    public TableConfiguration getTabconfig() {
        return tabconfig;
    }

    /**
     * @param tabconfig the tabconfig to set
     */
    public void setTabconfig(TableConfiguration tabconfig) {
        this.tabconfig = tabconfig;
    }

    /**
     * @param tableConfigurations the tableConfigurations to set
     */
