...
import static org.mybatis.generator.util.messages.Messages.getString;
...
public class TableConfiguration extends PropertyHolder {
    ...
    public boolean areAnyStatementsEnabled() {
        return this.selectAllStatementEnabled || selectByPrimaryKeyStatementEnabled || insertStatementEnabled
                || updateByPrimaryKeyStatementEnabled || this.countStatementEnabled
    ...
    public XmlElement toXmlElement() {
        ...
        if (!this.countStatementEnabled) {
            xmlElement.addAttribute(new Attribute("count", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }

        if (!this.selectAllStatementEnabled) {
            xmlElement.addAttribute(new Attribute("selectAll", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
    ...
    /**
     * @return the selectAllStatementEnabled
     */
    ...
    /**
     * @param selectAllStatementEnabled the selectAllStatementEnabled to set
     */
    ...
    /**
     * @return the countStatementEnabled
     */
    ...
    /**
     * @param countStatementEnabled the countStatementEnabled to set
     */
    public void setCountStatementEnabled(boolean countStatementEnabled) {
        this.countStatementEnabled = countStatementEnabled;
    }
