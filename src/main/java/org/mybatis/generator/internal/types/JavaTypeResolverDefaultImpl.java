...
public class JavaTypeResolverDefaultImpl implements JavaTypeResolver {
    ...
    public JavaTypeResolverDefaultImpl() {
        ...
        typeMap.put(Types.BIT, new JdbcTypeInformation("INTEGER", new FullyQualifiedJavaType(Integer.class.getName())));
        ...
        typeMap.put(Types.DATE, new JdbcTypeInformation("TIMESTAMP", new FullyQualifiedJavaType(Date.class.getName())));
