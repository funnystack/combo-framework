...
public class MyBatisGeneratorMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        Set<String> fullyqualifiedTables = AutohomeConfigurationParser.getTables(tableNames);
        AutohomeConfig autohomeConfig = new AutohomeConfig(project.getBasedir().getAbsolutePath(), daoDirectory,
        ...
        try {
            ...
            AutoHomeMybatisGenerator myBatisGenerator = new AutoHomeMybatisGenerator(config, callback, warnings);
    ...
    private void createSubMoudle(String dirName) {
        // 创建model层
        String mkdir_order = "mvn archetype:generate -DinteractiveMode=false -DgroupId=cn.com.autohome -DartifactId="
