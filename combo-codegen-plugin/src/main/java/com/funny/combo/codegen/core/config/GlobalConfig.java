...
public class GlobalConfig implements Serializable {
    public static final String MYSQL_CONCAT_URL ="?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC&nullCatalogMeansCurrent=true";
    ...
    public ComboCodeConfig getComboCodeConfig() {
        return comboCodeConfig;
    }

    public void setComboCodeConfig(ComboCodeConfig comboCodeConfig) {
        this.comboCodeConfig = comboCodeConfig;
    }
}