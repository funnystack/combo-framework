...
import com.funny.combo.codegen.core.resolver.JavaTypeResolverImpl;
...
public class AutoCodeConfigurationParser {
    ...
    protected void parseTable(Context context) {
        ...
        if (StringUtility.stringHasValue(globalConfig.getTableNames())) {
            StringTokenizer st = new StringTokenizer(globalConfig.getTableNames(), ",");
    ...
    protected void parseSqlMapGenerator(Context context) {
        ...
        String targetPackage = "mapper." + globalConfig.getModuleName();
        String targetProject = globalConfig.getDaoDirectory() + "/src/main/resources";
    ...
    private void parseJavaClientGenerator(Context context) {
        ...
        javaClientGeneratorConfiguration
                .setTargetPackage(globalConfig.getPackageName() + "." + globalConfig.getModuleName()+".dao");
