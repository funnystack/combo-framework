...
/**
 * Created by funny on 2017/3/29.
 */
public class AutoCodeMybatisGenerator {
     ...
     */
    public AutoCodeMybatisGenerator(Configuration configuration, ShellCallback shellCallback, List<String> warnings)
