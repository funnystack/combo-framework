...
/**
 * Define AutohomeMarkDeletedByIdElementGenerator.
 * <p>Created with IntelliJ IDEA on 03/12/2016 15:00.</p>
 *
 * @author yangyanju [yangyanju@autohome.com.cn]
 * @version 1.0
 */
public class AutohomeMarkDeletedByIdElementGenerator extends AbstractXmlElementGenerator {

    public AutohomeMarkDeletedByIdElementGenerator() {
        super();
    }
