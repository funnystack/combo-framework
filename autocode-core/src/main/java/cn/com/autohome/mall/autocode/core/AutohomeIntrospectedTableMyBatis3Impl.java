...
import cn.com.autohome.mall.autocode.core.javamapper.BasicJavaMapperGenerator;
import cn.com.autohome.mall.autocode.core.javamodel.AutohomeJavaRecordGenerator;
import cn.com.autohome.mall.autocode.core.javamodel.BasicJavaRecordGenerator;
...
import cn.com.autohome.mall.autocode.core.javamapper.AutohomeJavaMapperGenerator;
import cn.com.autohome.mall.autocode.core.xmlmapper.AutohomeEntityXMLMapperGenerator;
import cn.com.autohome.mall.autocode.core.javamodel.AutohomeJavaQueryGenerator;
import cn.com.autohome.mall.autocode.core.javamodel.AutohomeJavaEntityGenerator;

/**
 * Define AutohomeIntrospectedTableMyBatis3Impl.
 * <p>
 ...
 * @version 1.0
 */
public class AutohomeIntrospectedTableMyBatis3Impl extends IntrospectedTableMyBatis3Impl {
    ...
    protected AbstractJavaClientGenerator createJavaClientGenerator() {
        ...
        if ("XMLMAPPER".equalsIgnoreCase(type)) { //$NON-NLS-1$
            javaGenerator = new AutohomeJavaMapperGenerator();
    ...
    protected void calculateXmlMapperGenerator(AbstractJavaClientGenerator javaClientGenerator, List<String> warnings,
        ...
        if (javaClientGenerator == null) {
            if (context.getSqlMapGeneratorConfiguration() != null) {
                xmlMapperGenerator = new AutohomeEntityXMLMapperGenerator();
            }
        } else {
    ...
    protected void calculateJavaModelGenerators(List<String> warnings, ProgressCallback progressCallback) {
        ...
        if (getRules().generateBaseRecordClass()) {
            AbstractJavaGenerator javaModelGenerator = new AutohomeJavaEntityGenerator();
            initializeAbstractGenerator(javaModelGenerator, warnings, progressCallback);
            javaModelGenerators.add(javaModelGenerator);

            AbstractJavaGenerator javaRecordGenerator = new AutohomeJavaRecordGenerator();
