 ...
 * 
 */
public class AutohomeUpdateByPrimaryKeySelectiveElementGenerator extends AbstractXmlElementGenerator {

    public AutohomeUpdateByPrimaryKeySelectiveElementGenerator() {
        super();
    }
