package cn.com.autohome.mall.autocode.core.config;

/**
 * Created by funny on 2017/1/16.
 */
public class AutohomeConfig {
    ...
    public AutohomeConfig(String targetDirectory, String daoDirectory, String domainDirectory, boolean verbose,
